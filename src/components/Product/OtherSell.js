    ...
    <>
      <div class="tom-sell">
        <div class="tom-sell-product">
          ...
          <p class="tom-sell-title">香檳玫瑰護色護髮素</p>
          <p class="tom-sell-title">$1000/5ml</p>

          <p class="tom-sell-desicription">
            機哩瓜啦很多機哩瓜啦很 妝與毛孔髒污,做到充分的卸妝力。在有效溶解
        ...
        <div class="tom-sell-product">
          ...
          <p class="tom-sell-desicription">
            機哩瓜啦很多機哩瓜啦很 妝與毛孔髒污,做到充分的卸妝力。在有效溶解
            彩妝髒污的同時,為肌膚留下原生的 保護屏障,卸後不乾澀、不緊繃,
            維持肌膚原應有的
          </p>
        </div>
      </div>
